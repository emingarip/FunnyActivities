...
namespace FunnyActivities.Infrastructure.Migrations
{
    ...
    [Migration("20251121163000_AddPromptTemplates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FunnyActivities.Domain.Entities.ActivityUser", b =>
                {
                    b.Property<Guid>("ActivityId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FunnyActivities.Domain.Entities.LlmSetting", b =>
                {
                    b.Property<int>("Id")
                    ...
                    b.Property<int>("ModelCacheSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(300);
                    ...
                    b.Property<string>("OllamaHealthCheckModel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("OllamaPreferredModelsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("OpenAiAllowedModelsJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("OpenAiDefaultModel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("FunnyActivities.Domain.Entities.PromptCallLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PromptCallLogs");
                });

            modelBuilder.Entity("FunnyActivities.Domain.Entities.PromptTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("OutputFormatHint")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
            ...
            modelBuilder.Entity("FunnyActivities.Domain.Entities.PersonaActivityAssociation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PersonaId", "ActivityId")
                        .IsUnique();

                    b.ToTable("PersonaActivityAssociations");
                });

            modelBuilder.Entity("FunnyActivities.Domain.Entities.PersonaCharacteristic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PersonaId", "Order");

                    b.ToTable("PersonaCharacteristics");
                });
            ...
            modelBuilder.Entity("FunnyActivities.Domain.Entities.PersonaActivityAssociation", b =>
                {
                    ...
                    b.HasOne("FunnyActivities.Domain.Entities.Persona", "Persona")
                        .WithMany("ActivityAssociations")
                        .HasForeignKey("PersonaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FunnyActivities.Domain.Entities.PromptCallLog", b =>
                {
                    b.HasOne("FunnyActivities.Domain.Entities.PromptTemplate", "Template")
                        .WithMany()
